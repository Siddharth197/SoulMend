            ...
            <div className="container">
                <div className={styles.footerGrid}>
                    ...
                    <div className={styles.footerColumn}>
                        <h3 className={styles.footerTitle}>SoulMend</h3>
                        <p className={styles.footerText}>
                            Authentic Thai healing products and professional massage services across India.
                        </p>
                    ...
                    <div className={styles.footerColumn}>
                        ...
                        <ul className={styles.contactInfo}>
                            ...
                            <li>
                                <span className={styles.contactIcon}>📧</span>
                                <a href="mailto:info@soulmend.com">info@soulmend.com</a>
                            </li>
                            <li>
                                <span className={styles.contactIcon}>📍</span>
                ...
                <div className={styles.trustBadges}>
                    ...
                    <div className={styles.badge}>✓ 100% Authentic</div>
                    <div className={styles.badge}>↩️ Easy Returns</div>
                </div>

                {/* Bottom Bar */}
                <div className={styles.footerBottom}>
                    <p>&copy; 2024 SoulMend. All rights reserved to Zenvia Care India Pvt Ltd.</p>
